...
type Notification struct {
	...
	SenderID    *uuid.UUID           `json:"senderId,omitempty" gorm:"size:36;index"`
	ReceiverIDs string               `json:"receiverIds,omitempty" gorm:"type:text"`
	TemplateID  *uuid.UUID           `json:"templateId,omitempty" gorm:"size:36;index"`
...
type NotificationInbox struct {
	systemModel.BaseModel
	TenantID        string        `json:"tenantId" gorm:"size:36;index"`
	NotificationID  uuid.UUID     `json:"notificationId" gorm:"size:36;index;not null"`
	ReceiverID      uuid.UUID     `json:"receiverId" gorm:"size:36;index;not null"`
...
type NotificationJob struct {
	systemModel.BaseModel
	TenantID       string                `json:"tenantId" gorm:"size:36;index"`
	NotificationID uuid.UUID             `json:"notificationId" gorm:"size:36;not null;index"`
