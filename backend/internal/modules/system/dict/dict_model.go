...
type DictType struct {
	...
	TenantID    string         `json:"tenant_id" gorm:"size:36;uniqueIndex:uniq_dict_type_tenant_name,priority:1;uniqueIndex:uniq_dict_type_tenant_code,priority:1"`
...
type DictData struct {
	ID          uuid.UUID      `json:"id" gorm:"size:36;primaryKey"`
	TypeID      uuid.UUID      `json:"type_id" gorm:"size:36;notNull;index"`
