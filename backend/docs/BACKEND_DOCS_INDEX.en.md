...
2. Continue with `docs/DOCS_INDEX.md`
3. Read `backend/BACKEND_GUIDE.en.md` for backend architecture and startup flow
4. Read `backend/docs/BACKEND_NAMING_CONVENTIONS.en.md` for naming and file organization rules
5. Continue with the English topic docs under `system/`, `auth/`, and `tenant/`
6. Use the Chinese topic docs when you need the full current implementation detail
7. Read `backend/cmd/tools/README.md` when working with backend tools
8. Check `backend/api/swagger/` for generated API output
