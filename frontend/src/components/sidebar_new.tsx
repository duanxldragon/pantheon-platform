...
import { getMenuLabel, inferMenuViewId, getViewConfig, getViewConfigByComponent, inferMenuComponent } from '../shared/constants/views_config';
...
function isSystemRootMenu(menu: SystemMenu, viewId: string): boolean {
  ...
  return menu.parentId == null && (
    ...
    name === 'system' ||
    title.includes('系统管理') ||
    component === 'system/system_dashboard'
  );
}
