...
const zhCopy: SystemSettingsCopy = {
  ...
  actions: {
    ...
    viewDetail: '查看详情',
    copyChanges: '复制差异摘要',
    exportChanges: '导出差异摘要',
    viewChanges: '查看差异详情',
    viewAllChanges: '查看全部差异',
    confirmSubmit: '提交前确认',
  },
  messages: {
    invalidFile: '无效的配置文件格式',
    importReload: '系统设置导入成功，页面即将刷新',
    changesCopied: '差异摘要已复制',
    changesCopyFailed: '复制差异摘要失败',
    changesExported: '差异摘要已导出',
  },
  logic: {
    loading: '正在同步系统配置...',
    success: '系统配置已更新',
  ...
  detail: {
    title: '配置详情',
    description: '查看当前配置项的键、类型、状态和当前值。',
    sections: {
      summary: '配置摘要',
      behavior: '行为约束',
      changes: '待同步变更',
  ...
  submit: {
    title: '提交前确认',
    description: '在同步到后端前，再次确认本次配置改动范围。',
    summaryTitle: '本次提交摘要',
    affectedSections: '涉及分组',
    affectedItems: '涉及配置项',
    currentSection: '当前分组',
    continueSubmit: '确认并同步',
    reviewTitle: '变更审阅',
    reviewDescription: '优先识别本次提交里最密集的分组与整体提交风险。',
    focusSection: '重点分组',
    reviewRisk: '提交风险',
    reviewRiskHigh: '本次提交范围较大，建议再次核对',
    reviewRiskLow: '本次提交范围可控',
    reviewHint: '重点确认影响较多的分组是否已经完成逐项检查。',
    reviewAction: '审阅动作',
  },
  success: {
    title: '同步成功',
    description: '本次配置变更已经提交到后端，可继续复核重点分组或进入下一轮调整。',
    savedAt: '同步时间',
    affectedSections: '已同步分组',
    affectedItems: '已同步配置项',
    currentSection: '提交来源分组',
    focusSection: '重点复核分组',
    savedKeys: '已同步键',
    reviewOutcome: '复核结论',
    reviewAction: '建议动作',
    reviewScope: '复核范围',
    continueReview: '定位重点分组',
    dismiss: '收起结果',
  },
  sections: {
    basic: {
...
const enCopy: SystemSettingsCopy = {
  ...
  actions: {
    ...
    copyChanges: 'Copy Change Summary',
    exportChanges: 'Export Change Summary',
  ...
  messages: {
    ...
    changesCopied: 'Change summary copied',
    changesCopyFailed: 'Failed to copy change summary',
    changesExported: 'Change summary exported',
  },
  logic: {
  ...
  detail: {
    ...
    description: 'Review the key, type, state, and active value of the selected setting.',
    sections: {
  ...
  submit: {
    ...
    description: 'Review the scope of this configuration update before syncing to the backend.',
    summaryTitle: 'Submission Summary',
    affectedSections: 'Affected Sections',
    affectedItems: 'Affected Items',
    currentSection: 'Current Section',
    continueSubmit: 'Confirm and Sync',
    reviewTitle: 'Change Review',
    reviewDescription: 'Identify the densest section and overall submission risk before syncing.',
    focusSection: 'Focus Section',
    reviewRisk: 'Submission Risk',
    reviewRiskHigh: 'This submission is broad and should be reviewed again',
    reviewRiskLow: 'This submission remains manageable',
    reviewHint: 'Double-check the sections with the highest number of pending updates.',
    reviewAction: 'Review Actions',
  },
  success: {
    title: 'Sync Completed',
    description: 'The configuration changes have been submitted. Continue reviewing the key section or move on to the next update.',
    savedAt: 'Synced At',
    affectedSections: 'Synced Sections',
    affectedItems: 'Synced Items',
    currentSection: 'Source Section',
    focusSection: 'Focus Section',
    savedKeys: 'Synced Keys',
    reviewOutcome: 'Review Outcome',
    reviewAction: 'Recommended Action',
    reviewScope: 'Review Scope',
    continueReview: 'Go To Focus Section',
    dismiss: 'Dismiss',
  },
  sections: {
    basic: {
