...
export function ThemedDataTable<T extends Record<string, unknown>>({
  ...
  return (
    <div>
      <div
        className="overflow-hidden rounded-[24px] border shadow-[0_20px_48px_-34px_rgba(15,23,42,0.22)]"
        style={{
          ...
          <TableBody>
            {displayData.length === 0 ? (
              <TableRow>
                ...
                >
                  <div
                    className="mx-auto flex max-w-sm flex-col items-center rounded-[24px] border border-dashed px-6 py-8 text-center"
                    style={{
                      borderColor: theme.colors.border,
                      backgroundColor: theme.colors.hover,
                    }}
                  >
                    <div className="text-[11px] font-semibold uppercase tracking-[0.18em]" style={{ color: theme.colors.textSecondary }}>
                      EMPTY
                    </div>
                    <div className="mt-3 text-sm font-semibold" style={{ color: theme.colors.text }}>
                      暂无可展示数据
                    </div>
