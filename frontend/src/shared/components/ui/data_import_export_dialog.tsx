      ...
      <DialogContent className="max-w-[448px]">
        ...
        {mode === 'import' ? (
          <div className="space-y-4 py-4">
            <div 
              className={`rounded-[24px] border-2 border-dashed p-8 text-center transition-all cursor-pointer
                ${dragActive ? 'border-blue-500 bg-blue-50 shadow-[0_16px_32px_-24px_rgba(59,130,246,0.45)]' : 'border-gray-300 bg-slate-50/70 hover:-translate-y-0.5 hover:border-gray-400'}
                ${file ? 'bg-green-50 border-green-500 shadow-[0_16px_32px_-24px_rgba(34,197,94,0.35)]' : ''}
              `}
        ...
        <div className="flex justify-end gap-3 rounded-[24px] border border-slate-200/70 bg-slate-50/80 px-4 py-3">
