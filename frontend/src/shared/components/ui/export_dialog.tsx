  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {availableFormats.map((fmt) => {
                  ...
                  return (
                    <div
                      key={fmt}
                      className={`flex items-center space-x-2 rounded-2xl border p-3 cursor-pointer transition-all ${
                        format === fmt
                          ? 'border-blue-500 bg-blue-50 shadow-[0_14px_28px_-22px_rgba(59,130,246,0.45)]'
                          : 'border-gray-200 bg-white/90 hover:-translate-y-0.5 hover:border-gray-300'
                      }`}
          ...
          {exportColumns.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="grid max-h-48 grid-cols-2 gap-2 overflow-y-auto rounded-2xl border border-slate-200/80 bg-slate-50/85 p-3">
        ...
        <DialogFooter className="rounded-[24px] border border-slate-200/70 bg-slate-50/80 px-4 py-3">
          <Button
            variant="outline"
