...
export function DeleteConfirmDialog({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="overflow-hidden border-none bg-gradient-to-br from-white via-white to-rose-50/35 p-0 shadow-[0_32px_80px_-40px_rgba(15,23,42,0.45)]">
        <AlertDialogHeader className="px-6 py-6 text-left">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-rose-100 shadow-sm">
        ...
        <AlertDialogFooter className="border-t border-slate-100/90 bg-gradient-to-r from-slate-50/88 via-white/80 to-rose-50/45 px-6 py-4 sm:justify-between">
